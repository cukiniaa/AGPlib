...
std::vector<Kernel::Point_2> single_vertex (const std::vector<Kernel::Point_2> &points) {
    return { points[0] };
}

std::vector<Kernel::Point_2> all_vertices (const std::vector<Kernel::Point_2> &points) {
    return points;
}

std::vector<Kernel::Point_2> discretization_min_dist(const std::vector<Kernel::Point_2> &points) {
    ...
    std::vector<Kernel::Point_2> discretization(discretization_set.begin(), discretization_set.end());
